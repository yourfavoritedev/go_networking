...
func (d *Data) UnmarshalBinary(p []byte) error {
	// initial sanity check to determine whether the packet size is within the expected bounds
	...
	// read operation code and check it
	...
	// stuff remaining byte into a new buffer and assign to Data.Payload
...
func (a Ack) MarshalBinary() ([]byte, error) {
	...
	err := binary.Write(b, binary.BigEndian, OpAck) // write operaton code
	if err != nil {
		return nil, err
	}
